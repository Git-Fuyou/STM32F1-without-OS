...
说明：1.实现sdio相关IO初始化，SD卡读写等
	  2.需要stm32f10x_sdio、stm32f10x_dma、misc.h支持，在stm32f10x_conf.h中打开
	  3.DMA模式有问题
------------------------------------------------------------------------*/
...
static u8 DeviceMode=SD_DMA_MODE;					//工作模式SD_DMA_MODE，SD_POLLING_MODE
