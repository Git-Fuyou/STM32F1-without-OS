...
//   1： __align(32)   表示32字节对齐，	    
//   2： __attribute__ 这个是用来指定变量或结构位域的特殊属性,该关键字后的双括弧中的内容是属性说明。 
//   3： at关键字      该关键字可以用来设置变量的绝对地址,也就是你可以通过这个关键字,指定某个变量处于内存里面的某个给定的地址. 

//   综合起来,就是设置变量从0X68000000地址开始，32字节对齐存放。
